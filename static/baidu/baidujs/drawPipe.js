...
//map.disableDoubleClickZoom()
   $.ajax({
        ...
        console.log(polylinePointSum)
        pipeShow(1,drawPoint,polylinePointSum,pipeIdArray,pipeNameArray,pipeColorArray,pipeWidthArray,pipeTypeArray,pipeDataArray);
   ...
   $.ajax({
        ...
        pipeShow(2,trackdrawPoint,trackpolylinePointSum,trackpipeIdArray,trackpipeNameArray,trackpipeColorArray,trackpipeWidthArray,trackpipeTypeArray,trackpipeDataArray);
...
function pipeShow(type,drawPoint,polylinePointSum,pipeIdArray,pipeNameArray,pipeColorArray,pipeWidthArray,pipeTypeArray,pipeDataArray)
{
    switch(type)
    {
    case 1:
